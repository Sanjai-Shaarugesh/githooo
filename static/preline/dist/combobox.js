	...
	(() => {
		...
		var t = {
							...
							function e(e, o, i) {
								...
								return (
									...
									(B.viewport =
										null !==
											(n =
												'string' == typeof (null == V ? void 0 : V.viewport)
													? document.querySelector(
															null == V ? void 0 : V.viewport,
														)
													: null == V
														? void 0
														: V.viewport) && void 0 !== n
											...
											: null),
									(B.preventVisibility =
										null !== (s = null == V ? void 0 : V.preventVisibility) &&
										void 0 !== s &&
										s),
									(B.minSearchLength =
										null !== (l = null == V ? void 0 : V.minSearchLength) &&
										void 0 !== l
											? l
											: 0),
									(B.apiUrl =
										null !== (a = null == V ? void 0 : V.apiUrl) && void 0 !== a
											? a
											: null),
									(B.apiDataPart =
										null !== (u = null == V ? void 0 : V.apiDataPart) &&
										void 0 !== u
											? u
											: null),
									(B.apiQuery =
										null !== (c = null == V ? void 0 : V.apiQuery) &&
										void 0 !== c
											? c
											: null),
									(B.apiSearchQuery =
										null !== (p = null == V ? void 0 : V.apiSearchQuery) &&
										void 0 !== p
											? p
											: null),
									(B.apiSearchPath =
										null !== (d = null == V ? void 0 : V.apiSearchPath) &&
										void 0 !== d
											? d
											: null),
									(B.apiSearchDefaultPath =
										null !==
											(h = null == V ? void 0 : V.apiSearchDefaultPath) &&
										void 0 !== h
											? h
											: null),
									(B.apiHeaders =
										null !== (m = null == V ? void 0 : V.apiHeaders) &&
										void 0 !== m
											? m
											: {}),
									(B.apiGroupField =
										null !== (f = null == V ? void 0 : V.apiGroupField) &&
										void 0 !== f
											? f
											: null),
									(B.outputItemTemplate =
										null !== (v = null == V ? void 0 : V.outputItemTemplate) &&
										void 0 !== v
											? v
									...
									(B.outputEmptyTemplate =
										null !== (b = null == V ? void 0 : V.outputEmptyTemplate) &&
										void 0 !== b
											? b
									...
									(B.outputLoaderTemplate =
										null !==
											(g = null == V ? void 0 : V.outputLoaderTemplate) &&
										void 0 !== g
											? g
									...
									(B.groupingType =
										null !== (y = null == V ? void 0 : V.groupingType) &&
										void 0 !== y
											? y
											: null),
									(B.groupingTitleTemplate =
										null !==
											(x = null == V ? void 0 : V.groupingTitleTemplate) &&
										void 0 !== x
											? x
									...
									(B.tabsWrapperTemplate =
										null !== (E = null == V ? void 0 : V.tabsWrapperTemplate) &&
										void 0 !== E
											? E
											: '<div class="overflow-x-auto p-4"></div>'),
									(B.preventSelection =
										null !== (S = null == V ? void 0 : V.preventSelection) &&
										void 0 !== S &&
										S),
									(B.preventAutoPosition =
										null !== (L = null == V ? void 0 : V.preventAutoPosition) &&
										void 0 !== L &&
										L),
									(B.isOpenOnFocus =
										null !== (T = null == V ? void 0 : V.isOpenOnFocus) &&
										void 0 !== T &&
										T),
									(B.input =
										null !==
											(C = B.el.querySelector('[data-hs-combo-box-input]')) &&
										void 0 !== C
											? C
											: null),
									(B.output =
										null !==
											(w = B.el.querySelector('[data-hs-combo-box-output]')) &&
										void 0 !== w
											? w
											: null),
									(B.itemsWrapper =
										null !==
											(A = B.el.querySelector(
									...
									(B.toggle =
										null !==
											(O = B.el.querySelector('[data-hs-combo-box-toggle]')) &&
										void 0 !== O
											? O
											: null),
									(B.toggleClose =
										null !==
											(P = B.el.querySelector('[data-hs-combo-box-close]')) &&
										void 0 !== P
											? P
											: null),
									(B.toggleOpen =
										null !==
											(_ = B.el.querySelector('[data-hs-combo-box-open]')) &&
										void 0 !== _
											? _
											: null),
							...
							return (
								...
								(e.prototype.setGroups = function () {
									...
									this.items.forEach(function (e) {
										...
										t.some(function (t) {
											return (null == t ? void 0 : t.name) === o.name;
										}) || t.push(o);
									}),
										(this.groups = t);
								}),
												...
												.forEach(function (e) {
													...
													t.items.filter(function (t) {
														return (
															...
															).group.name === o && 'block' === t.style.display
														);
													}).length
														? (e.style.display = 'block')
														: (e.style.display = 'none');
								...
								(e.prototype.buildInput = function () {
									...
									this.isOpenOnFocus &&
										...
										(this.onInputInputListener = (0, c.debounce)(function (e) {
								...
								(e.prototype.buildToggle = function () {
									...
									this.isOpened
										...
										: ((null === (o = null == this ? void 0 : this.toggle) ||
											void 0 === o
												? void 0
												: o.ariaExpanded) &&
									...
									this.itemsWrapper
										...
										this.preventSelection ||
											t.addEventListener('click', function () {
												o.close(i, n),
													o.setSelectedByValue(o.valuesBySelector(t));
											});
								}),
								...
								(e.prototype.jsonItemsRender = function (t) {
									...
									t.forEach(function (t, o) {
										var i = (0, c.htmlToElement)(e.outputItemTemplate);
										i.setAttribute(
											'data-hs-combo-box-item-stored-data',
											JSON.stringify(t),
										),
											i
												...
												.forEach(function (o) {
													...
													(o.textContent = null != i ? i : ''),
														!i && n && (o.style.display = 'none');
												}),
											i
											...
											i
												...
												.forEach(function (e) {
													JSON.parse(
														...
														e.setAttribute(o.attr, t[o.valueFrom]);
													});
												}),
											i.setAttribute('tabIndex', ''.concat(o)),
											('tabs' !== e.groupingType &&
								...
								(e.prototype.groupTabsRender = function () {
									...
									var i = (0, c.htmlToElement)(this.groupingTitleTemplate);
									i.setAttribute('data-hs-combo-box-group-title', 'all'),
										...
										this.groups.forEach(function (e) {
											var i = (0, c.htmlToElement)(t.groupingTitleTemplate);
											...
											(this.preventVisibility
												...
												: ((this.animationInProcess = !0),
													...
													(0, c.afterTransition)(this.output, function () {
														(n.output.style.display = 'none'),
															n.setValueAndClear(t, e || null),
								...
								(e.getInstance = function (t, e) {
									var o = window.$hsComboBoxCollection.find(function (e) {
										return (
											e.element.el ===
										...
										document
											...
											.forEach(function (t) {
												if (
													...
													var o = t.getAttribute('data-hs-combo-box'),
														i = o ? JSON.parse(o) : {};
													new e(t, i);
												}
											});
								...
								(e.setHighlighted = function (t, e, o) {
									e.focus(),
										(o.value = e
											.querySelector('[data-hs-combo-box-value]')
											.getAttribute('data-hs-combo-box-search-text')),
								...
								(e.onArrow = function (t) {
									...
									if (i) {
										var n =
											null !== (o = i.element.itemsWrapper) && void 0 !== o
												? o
												: i.element.output;
										if (!n) return !1;
										var r,
											s = e.getPreparedItems(t, n),
											l = n.querySelector(
												'.hs-combo-box-output-item-highlighted',
											);
										l ||
								...
								(e.onEnter = function (t) {
									var e,
										...
										i = window.$hsComboBoxCollection.find(function (e) {
											return (
												!(0, c.isParentOrElementHidden)(e.element.el) &&
												t.target.closest('[data-hs-combo-box]') === e.element.el
											);
										}),
										n = i.element.el.querySelector(
											'.hs-combo-box-output-item-highlighted a',
										);
									o.hasAttribute('data-hs-combo-box-input')
										? (i.element.close(), o.blur())
				...
				292: function (t, e) {
					...
					e.getClassProperty = function (t, e, o) {
						return (
							void 0 === o && (o = ''),
					...
					e.getClassPropertyAlt = function (t, e, o) {
						void 0 === o && (o = '');
						var i = '';
						return (
					...
					e.isEnoughSpace = function (t, e, o, i, n) {
						void 0 === o && (o = 'auto'),
							void 0 === i && (i = 10),
							void 0 === n && (n = null);
						var r = e.getBoundingClientRect(),
							s = n ? n.getBoundingClientRect() : null,
							l = window.innerHeight,
							a = s ? r.top - s.top : r.top,
							u = (n ? s.bottom : l) - r.bottom,
							c = t.clientHeight + i;
						return 'bottom' === o
							? u >= c
							: 'top' === o
					...
					e.classToClassList = function (t, e, o, i) {
						void 0 === o && (o = ' '),
							void 0 === i && (i = 'add'),
