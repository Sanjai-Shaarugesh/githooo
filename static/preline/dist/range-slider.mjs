var t = {
		615: (t, o, i) => {
			...
			class e {
				...
				fireEvent(t, o = null) {
					if (this.events.hasOwnProperty(t)) return this.events[t](o);
				}
				on(t, o) {
					this.events[t] = o;
				}
 ...
 */ class s extends n.A {
	constructor(t, o, i) {
		super(t, o, i);
		const e = t.getAttribute('data-hs-range-slider'),
			n = e ? JSON.parse(e) : {};
	...
	processClasses(t) {
		...
		return (
			Object.keys(t).forEach((i) => {
				i && (o[i] = `${noUiSlider.cssClasses[i]} ${t[i]}`);
			}),
			o
		);
	}
	init() {
		var t, o, i, e, n, s, r, l, a, d, c, h, v;
	...
	prefixOrPostfixFormatter() {
		var t;
		(this.format = { to: (t) => this.formatValue(t), from: (t) => +t }),
			(null === (t = this.concatOptions) || void 0 === t
				? void 0
				: t.tooltips) && (this.concatOptions.tooltips = this.format);
	}
	...
	static getInstance(t, o = !1) {
		const i = window.$hsRangeSliderCollection.find(
			(o) =>
				o.element.el === ('string' == typeof t ? document.querySelector(t) : t),
		);
	...
	static autoInit() {
		window.$hsRangeSliderCollection || (window.$hsRangeSliderCollection = []),
			...
			document
				...
				.forEach((t) => {
					window.$hsRangeSliderCollection.find((o) => {
						var i;
						return (
							(null === (i = null == o ? void 0 : o.element) || void 0 === i
								? void 0
								: i.el) === t
						);
					}) || new s(t);
	...
	static on(t, o, i) {
		const e = window.$hsRangeSliderCollection.find(
			(t) =>
				t.element.el === ('string' == typeof o ? document.querySelector(o) : o),
		);
		e && (e.element.events[t] = i);
	}
}
