						...
						c = (function (t) {
							function e(e, n, o) {
								...
								return (
									...
									i.update(),
									(i.isToggleStopPropagated = (0, s.stringToBoolean)(
							...
							return (
									...
									this.el.classList.add('active'),
										...
										setTimeout(function () {
											(e.content.style.height = ''.concat(
												...
												(0, s.afterTransition)(e.content, function () {
													(e.content.style.display = 'block'),
														(e.content.style.height = ''),
														e.fireEvent('open', e.el),
														(0, s.dispatch)('open.hs.accordion', e.el, e.el);
												});
										});
								}),
									...
									this.el.classList.remove('active'),
										...
										(0, s.afterTransition)(this.content, function () {
											(e.content.style.display = 'none'),
												...
												(0, s.dispatch)('close.hs.accordion', e.el, e.el);
										});
								}),
								...
								(e.hide = function (t) {
									var n = e.findInCollection(t),
										o = n ? window.getComputedStyle(n.element.content) : null;
									n && 'none' !== o.display && n.element.hide();
								}),
								(e.treeView = function () {
									var t = this;
									if (
										...
										this.selectable.length &&
											this.selectable.forEach(function (e) {
												e.el
													...
													.forEach(function (n) {
														var o = function (o) {
															return t.onSelectableClick(o, e, n);
														};
														n.addEventListener('click', o),
															e.listeners.push({ el: n, listener: o });
													});
											});
								}),
								...
								(e.onSelectableClick = function (t, n, o) {
									t.stopPropagation(), e.toggleSelected(n, o);
								}),
								e
							);
						})(l(n(961)).default);
				...
				292: function (t, e) {
					...
					e.isEnoughSpace = function (t, e, n, o, i) {
						...
						var r = e.getBoundingClientRect(),
							...
							c = l ? r.top - l.top : r.top,
							a = (i ? l.bottom : s) - r.bottom,
							u = t.clientHeight + o;
						return 'bottom' === n
							? a >= u
							: 'top' === n
