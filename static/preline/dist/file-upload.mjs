var e = {
		...
		926: (e, t, i) => {
			...
			const l = (e) => {
				...
				n = (e, t, i = ' ', l = 'add') => {
					e.split(i).forEach((e) =>
						'add' === l ? t.classList.add(e) : t.classList.remove(e),
					);
				};
		},
	},
...
function i(l) {
	...
	var o = (t[l] = { exports: {} });
	return e[l](o, o.exports, i), o.exports;
}
(i.d = (e, t) => {
	for (var l in t)
		i.o(t, l) &&
...
class a extends o.A {
	constructor(e, t, i) {
		...
		(this.previewTemplate =
			(null === (l = this.el.querySelector('[data-hs-file-upload-preview]')) ||
			void 0 === l
				? void 0
				: l.innerHTML) ||
	...
	tempFileInputChange(e, t) {
		var i;
		const l = null === (i = e.target.files) || void 0 === i ? void 0 : i[0];
		if (l) {
			const e = l;
	...
	previewAccepted(e) {
		const { previewElement: t } = e,
			...
			l = t.querySelector('[data-hs-file-upload-file-name]'),
			n = t.querySelector('[data-hs-file-upload-file-ext]'),
			o = t.querySelector('[data-hs-file-upload-file-size]'),
			a = t.querySelector('[data-hs-file-upload-file-icon]'),
	...
	createIcon(e) {
		...
		const l = (
			...
			? (0, n.fc)(this.extensions[e].icon)
			: (0, n.fc)(this.extensions.default.icon);
		return (
			(0, n.en)(
...
window.addEventListener('load', () => {
	document.querySelectorAll(
		...
		'undefined' != typeof _ && 'undefined' != typeof Dropzone && a.autoInit();
}),
	'undefined' != typeof window && (window.HSFileUpload = a);
const s = a;
var r = l.A;
export { r as default };
